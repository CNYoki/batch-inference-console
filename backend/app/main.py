...
from .api import admin_settings, api_tokens, auth, jobs, model_configs, prompts, tools, users
...
for module in (auth, api_tokens, jobs, model_configs, users, admin_settings, tools, prompts):
